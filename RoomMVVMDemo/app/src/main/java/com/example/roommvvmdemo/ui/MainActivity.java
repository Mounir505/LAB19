...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1. Liaison des composants graphiques de NOTRE layout
        ...
        // 3. Connexion au ViewModel
        noteViewModel = new ViewModelProvider(this).get(NoteViewModel.class);

        // 4. Observation des données (Mise à jour automatique de la liste)
        ...
        // 6. Gestion des clics sur les éléments de la liste
